...
export const NAV_GROUPS = [
  {
    ...
    items: [
      ...
      { to: '/admin/employees', labelKey: 'nav.employees', icon: ICONS.users },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/doctor/active-visits', labelKey: 'nav.activeVisits', icon: ICONS.clipboard },
      ...
      { to: '/doctor/diagnoses', labelKey: 'nav.diagnoses', icon: ICONS.clipboard },
    ],
  },
  {
    id: 'patient',
    ...
    items: [
      ...
      { to: '/patient/visits', labelKey: 'nav.visits', icon: ICONS.clipboard },
